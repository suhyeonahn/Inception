...
if [! -f "$WP-CONFIG"]; then
    ...
    #wp db create
    wp core install --url="https://suahn.42.fr" --title="home" --admin_user=$WORDPRESS_ADMIN_USER --admin_password=$WORDPRESS_ADMIN_PASSWORD --admin_email="https://agentsuahn.42.fr"
